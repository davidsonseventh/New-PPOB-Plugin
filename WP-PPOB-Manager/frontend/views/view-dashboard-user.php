...
<div class="wppob-frontend-wrap wppob-user-dashboard">
    ...
    <nav class="wppob-user-dashboard-nav">
        ...
        <?php if (get_option('wppob_transfer_enable', 'yes') === 'yes'): ?>
...
<?php endif; ?>
        ...
        <?php if (get_option('wppob_referral_enable') === 'yes'): ?>
        <a href="?tab=referral" class="<?php echo $active_tab === 'referral' ? 'active' : ''; ?>"><?php _e('Referral', 'wp-ppob'); ?></a>
        <?php endif; ?>
        <a href="?tab=security" class="<?php echo $active_tab === 'security' ? 'active' : ''; ?>"><?php _e('Keamanan', 'wp-ppob'); ?></a>
    </nav>
...
<div class="wppob-user-dashboard-content">
    ...
    switch ($active_tab) {
        ...
        case 'referral':
            include WP_PPOB_MANAGER_PLUGIN_DIR . 'frontend/views/view-referral-user.php';
            break;
            
        case 'security': // <-- DIPINDAHKAN KE SINI
            include WP_PPOB_MANAGER_PLUGIN_DIR . 'frontend/views/view-security-settings.php';
            break;
        default: // <-- SEKARANG HANYA ADA SATU DAN MENJADI CASE TERAKHIR
            global $wpdb;
