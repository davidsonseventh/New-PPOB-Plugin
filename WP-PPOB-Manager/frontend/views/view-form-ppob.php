...
?>
<div class="wppob-frontend-wrap" data-category-name="<?php echo esc_attr(strtolower($category->name)); ?>">
    ...
    <?php if (!empty($products)): ?>
        <div class="wppob-product-grid">
            <?php foreach ($products as $product): ?>
                <div class="wppob-product-item" 
                     ...
                     data-brand="<?php echo esc_attr(strtolower($product->get_meta('_wppob_brand'))); // Atribut brand untuk filter provider ?>">
                    <?php 
        ...
        <form id="wppob-purchase-form" class="wppob-purchase-form">
            ...
            <div class="wppob-form-group" id="wppob-barcode-wrapper" style="display: none;">
                <label for="wppob-barcode-no"><?php _e('Nomor Barcode / SN Voucher', 'wp-ppob'); ?></label>
                <input type="text" id="wppob-barcode-no" name="barcode_no" placeholder="Masukkan nomor barcode di sini">
            </div>
            ...
            <button type="submit" id="wppob-submit-purchase" disabled><?php _e('Beli Sekarang', 'wp-ppob'); ?></button>
        </form>
    <?php else: ?>
