...
class WPPOB_API {
    ...
    public function check_balance() {
        $body = [
            'cmd'       => 'deposit',
            'username'  => $this->username,
            // [FIXED] Signature untuk cek saldo menggunakan kunci 'deposit', bukan 'depo'
            'sign'      => $this->generate_signature('deposit') 
        ];
        // Endpoint untuk cek saldo adalah 'deposit'
        return $this->send_request('deposit', $body);
    }
